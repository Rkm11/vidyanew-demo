			...
			<td>
				<table class="ins-table">
					...
					<tr>
							...
							<table style="width: 100%;border-collapse: collapse;">
								<tbody>
									<tr>
										...
										<td  class="t-border" style="width: 40%;">&nbsp;<span>{{ $i->ad_preffered_batches }}</span></td>
						...
						<td style="width: 30%;">
							<p>Enquiry Date: <span>{{ Carbon\Carbon::parse($i->created_at)->toFormattedDateString() }}</span></p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="name">
							<span>{{ $i->stu_last_name }}</span>
						</td>
						<td class="name">
							<span>{{ $i->stu_first_name }}</span>
						</td>
						<td class="name">
							<span>{{ $i->stu_middle_name }}</span>
						</td>
					</tr>
				</table>
			</td>
			...
			<td>
				<table>
					<tr>
						...
						<td class="ad-line">
							<span class="line">{{ $i->stu_address }}</span>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr class="details">
			<td>
				<table>
					<tr>
						<td class="phone">
							<p>Phone: <span>{{ $i->stu_mobile }}</span></p>
						</td>
						<td class="cell">
