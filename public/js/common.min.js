...
if (typeof(ID) != "undefined" && ID !== null) {
            ...
            formSubmission: function(u, t, val = {}, id = null) {
                ...
                $('#' + form).on({
                    'submit': function(e) {
                        e.preventDefault();
                        urls=location.href;
                        if($('#validate_subject').val()!='' && (location.href==url+'/admission/create' 
                            || location.href==url+'/enquiry/create' || location.href==url+'/test/create') || 
                            urls.includes('test/edit') || location.href==url+'users/create')
                        {
    ...
    Msg = function() {
        var msgDetail = {
            ...
            EmailExist: {
                msg: 'Email Id already exist try different Id!!',
                class: 'danger'
            },
            error: {
        ...
        return {
            ...
            txt: function(type, id = null) {
                ...
                console.log('---');
                if(msgDetail[type]){
                console.log(msgDetail[type].class);
                ...
                this.timer(function() {
                    if (type == 'success' || type == 'successU') {
                        ...
                        if(ID=='test'){
                         location.href = en=$('#base_url').val()+'/test';;   
                        }

                        if(location.href==url+'/others/create'){
                            location.reload();
                            // alert(location.href);
                            // timetableData();
                        }
